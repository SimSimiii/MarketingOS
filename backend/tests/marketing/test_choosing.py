    ...
    provider.push(
        ...
        email_draft(
            ...
            body=(
                ...
                "Point Notewright at the branch you merged and read what comes back.\n"
...
_BODY_ONE = (
    ...
    "Point Notewright at the branch and read what comes back. Change the bits that are wrong\n"
...
_BODY_TWO = (
    ...
    "Aim Notewright at a merged branch and read the draft. Edit whatever is wrong and let\n"
...
_BODY_THREE = (
    ...
    "Give Notewright the twenty entries you already published and it will write like those\n"
...
_BODY_BLOCKED = (
    ...
    "Hand Notewright a branch and read the paragraph that comes back to you.\n\n"
...
_BODY_BLOCKED_TWO = (
    ...
    "Act now and Notewright writes it before the retro starts, from the commits that are\n"
...
_BODY_BLOCKED_THREE = (
    ...
    "Act now: give Notewright the twenty entries you published and it writes like those.\n\n"
