...
intention of using Codex themselves. The job is to convert that quota into committed,
...
```bash
python .Codex/skills/optimize/quota.py --json
```
...
`.Codex/skills/optimize/LEDGER.md`, newest first. Append, never rewrite. It is the memory
